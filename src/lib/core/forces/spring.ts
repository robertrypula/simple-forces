...
export class SpringForce extends Force {
  public constructor(public line: Line, public forceManager: SpringForceManager) {
    super(ForceType.Spring, forceManager);
  }

  public calculateForce(point: Point): void {
    const springMountingPoint: Point = this.line.pointA === point ? this.line.pointB : this.line.pointA;
    ...
    this.vector = direction.normalize().multiplyScalar(-x * this.forceManager.k - v * this.forceManager.b);
  }
}
